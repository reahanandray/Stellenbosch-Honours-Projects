...
print("Canopy Dataset using Random Forest:")
print(".")
...
# ===============================================================================
#                 First iteration - Run Canopy data as it is with RF
# ===============================================================================
...
# 6. TEST MODEL FUNCTION USING SAMPLE PREDICTION
...
predicted_cultivar = label_encoder.inverse_transform(prediction)

# Retrieve and display the sample
sample_dict = sample.iloc[0].to_dict()
print(f"\nSample Features: {sample_dict}")
print(f"Predicted Cultivar: {predicted_cultivar[0]}")
